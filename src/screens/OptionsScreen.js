      ...
      >
        {isLoading ? (
          <View style={styles.loaderContainer}>
            ...
            <Text style={styles.loaderText}>Importando dados...</Text>
          </View>
        ) : (
          <>
            ...
            <TouchableOpacity style={styles.optionButton} onPress={() => setIsAccountModalVisible(true)}>
              ...
              <Text style={styles.optionText}>Gerir Contas Bancarias</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.optionButton} onPress={() => setHelpModalVisible(true)}>
