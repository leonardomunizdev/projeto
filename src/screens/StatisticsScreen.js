          ...
          {incomeCategories.length > 0 ? (
            incomeCategories.map(item => (
              <View style={styles.tableRow} key={item.id}>
                ...
                <Text style={styles.tableCell}>{formatNumberBR(item.total)}</Text>
              </View>
            ))
          ) : (
              ...
              filteredTransactions.filter(transaction => transaction.type === 'income').map(item => (
                ...
                <View style={styles.transactionItemContainer} key={item.id}>
                  ...
                  <View style={styles.tableRow}>
                    ...
                    <Text style={styles.tableCell}>{formatNumberBR(item.amount)}</Text>
                    <Text style={styles.tableCell}>{item.categoryName}</Text>
                    <Text style={styles.tableCell}>{formatDateToBrazilian(item.date)}</Text>
